...
namespace PrestaShop\Module\OrderFeatures\Form\IdentifiableObject\DataProvider;
...
final class OrderStateFormDataProvider implements FormDataProviderInterface
{
    ...
    public function getData($orderStateId)
    {
        ...
        return [
            ...
            'send_email_warehouse' => $editableOrderState->isSendEmailWarehouse(),
            'email_warehouse' => $editableOrderState->getEmailWarehouse(),
