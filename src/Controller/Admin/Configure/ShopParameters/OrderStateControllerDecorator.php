...
class OrderStateControllerDecorator extends PrestaShopAdminController
{
    ...
    public function createAction(
        Request $request,
        #[Autowire(service: 'prestashop.module.form.identifiable_object.builder.order_state_form_builder')]
        FormBuilderInterface $orderStateFormBuilder,
        #[Autowire(service: 'prestashop.module.form.identifiable_object.handler.order_state_form_handler')]
